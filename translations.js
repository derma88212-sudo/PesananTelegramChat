...
export const UI_TRANSLATIONS = {
  ...
  menu_payments: {
    ...
    de: '💳 Zahlungsmethoden & Krypto',
    fr: '💳 Moyen de paiement & Crypto',
    pt: '💳 Formas de Pagamento e Cripto',
    hi: '💳 भुगतान के तरीके (क्रिप्टो)',
    uz: "💳 To'lov usullari (Kripto)",
    ar: '💳 طرق الدفع والعملات المشفرة',
    ja: '💳 支払い方法・暗号資産',
    tr: '💳 Ödeme Yöntemleri ve Kripto',
  ...
  menu_help: {
    ...
    de: 'ℹ️ Bedingungen & Garantie',
    fr: 'ℹ️ Conditions & Garantie',
    pt: 'ℹ️ Termos e Garantia',
    hi: 'ℹ️ नियम एवं वारंटी',
    uz: 'ℹ️ Shartlar va kafolat',
    ar: 'ℹ️ الشروط والضمان',
    ja: 'ℹ️ 利用規約・保証',
    tr: 'ℹ️ Şartlar ve Garanti',
  ...
  btn_buy_auto: {
    ...
    de: '⚡ Automatische Krypto-Zahlung',
    fr: '⚡ Paiement Crypto Automatique',
    pt: '⚡ Pagamento Automático Cripto',
    hi: '⚡ ऑटोमैटिक क्रिप्टो भुगतान',
    uz: '⚡ Avto Kripto to‘lov',
    ar: '⚡ دفع تلقائي بالعملات المشفرة',
    ja: '⚡ 自動暗号資産決済',
    tr: '⚡ Otomatik Kripto Ödeme',
  ...
  btn_buy_manual: {
    ...
    es: '🔄 Verificar Pago',
    de: '🔄 Zahlung prüfen / bestätigen',
    fr: '🔄 Vérifier / Confirmer le paiement',
    pt: '🔄 Verificar / Confirmar Pagamento',
    hi: '🔄 भुगतान की पुष्टि करें',
    uz: "🔄 To'lovni tekshirish",
    ar: '🔄 التحقق من الدفع',
    ja: '🔄 支払いを確認・認証する',
    tr: '🔄 Ödemeyi Kontrol Et / Onayla',
    ...
    de: 'Wählen Sie unten ein Produkt aus, um Preisdetails, Lagerbestand und Zahlungsmethoden anzuzeigen:',
    fr: 'Sélectionnez un produit ci-dessous pour consulter les détails du prix, la disponibilité du stock et les modes de paiement :',
    pt: 'Selecione um produto abaixo para ver detalhes de preço, disponibilidade de estoque e métodos de pagamento:',
    ...
    ja: '価格の詳細、在庫状況、お支払い方法を確認するには、以下から商品を選択してください：',
    tr: 'Fiyat detaylarını, stok durumunu ve ödeme yöntemlerini görüntülemek için aşağıdan bir ürün seçin:',
  ...
  out_of_stock_alert: {
    ...
    de: '❌ Entschuldigung, dieser Artikel ist derzeit ausverkauft. Bitte wählen Sie ein anderes Produkt oder warten Sie auf Nachschub.',
    fr: '❌ Désolé, ce produit est actuellement en rupture de stock. Veuillez choisir un autre article ou attendre le réapprovisionnement.',
    pt: '❌ Desculpe, este produto está esgotado no momento. Escolha outro item ou aguarde a reposição de estoque.',
    ...
    ja: '❌ 申し訳ありませんが、この商品は現在在庫切れです。他の商品を選択するか、入荷をお待ちください。',
    tr: '❌ Üzgünüz, bu ürünün stoğu tükendi. Lütfen başka bir ürün seçin veya stokların yenilenmesini bekleyin.',
  ...
  payment_pending_notice: {
    ...
    de: '⏳ Zahlung auf der Blockchain noch nicht erkannt oder bestätigt. Bitte schließen Sie Ihre Überweisung ab. Die Zugangsdaten werden ERST nach Verifizierung gesendet.',
    fr: '⏳ Paiement non encore détecté ou confirmé sur la blockchain. Veuillez effectuer votre transfert. Le compte ne sera envoyé QU\'APRÈS vérification du paiement.',
    pt: '⏳ Pagamento ainda não detectado ou confirmado na blockchain. Por favor, conclua sua transferência. A conta SÓ será enviada após a verificação do pagamento.',
    ...
    ja: '⏳ ブロックチェーン上で支払いがまだ検出または確認されていません。指定の金額を送金してください。お支払い確認後にのみアカウントが送信されます。',
    tr: '⏳ Ödeme henüz blok zincirinde algılanmadı veya onaylanmadı. Lütfen transferinizi tamamlayın. Hesap bilgileri YALNIZCA ödeme doğrulandıktan sonra gönderilecektir.',
  ...
  payment_success_header: {
    ...
    de: '🎉 ZAHLUNG BESTÄTIGT & KONTO ERFOLGREICH GESENDET!',
    fr: '🎉 PAIEMENT CONFIRMÉ ET COMPTE ENVOYÉ !',
    pt: '🎉 PAGAMENTO CONFIRMADO E CONTA ENVIADA!',
    hi: '🎉 भुगतान सफल! आपका खाता विवरण:',
    uz: "🎉 TO'LOV TASDIQLANDI VA HISOB YUBORILDI!",
    ar: '🎉 تم تأكيد الدفع بنجاح وإرسال بيانات الحساب!',
    ja: '🎉 お支払いが確認され、アカウントが送信されました！',
    tr: '🎉 ÖDEME ONAYLANDI VE HESAP GÖNDERİLDİ!',
  ...
  credentials_label: {
    ...
    de: '🔐 IHRE ZUGANGSDATEN (E-Mail:Passwort:Cookie):',
    fr: '🔐 VOS IDENTIFIANTS (E-mail:Mot de passe:Cookie) :',
    pt: '🔐 SUAS CREDENCIAIS (E-mail:Senha:Cookie):',
    ...
    ja: '🔐 あなたのアカウント情報 (Email:パスワード:Cookie):',
    tr: '🔐 HESAP BİLGİLERİNİZ (E-posta:Şifre:Çerez):',
 ...
 */
export function getUI(key, lang = 'en') {
  const item = UI_TRANSLATIONS[key];
  if (!item) return key;
  return item[lang] || item['en'] || item['en'] || key;
}

/**
 * Get localized Welcome text from settings object
 */
export function getLocalizedWelcome(settings = {}, lang = 'en') {
  ...
  return settings.welcome_text || DEFAULT_WELCOME_TEXTS['en'];
}

/**
 * Get localized Terms text from settings object
 */
export function getLocalizedTerms(settings = {}, lang = 'en') {
  if (!settings) settings = {};
  ...
  return settings.terms_text || DEFAULT_TERMS_TEXTS['en'];
}

/**
 * Get localized Payment Guide text from settings object
 */
export function getLocalizedPaymentGuide(settings = {}, lang = 'en') {
  if (!settings) settings = {};
  ...
  return settings.payment_guide_text || DEFAULT_PAYMENT_GUIDES['en'];
}

/**
 * Get localized Order Guide/Template text from settings object
 */
export function getLocalizedOrderGuide(settings = {}, lang = 'en') {
  if (!settings) settings = {};
  ...
  return settings.order_guide_text || DEFAULT_ORDER_GUIDES['en'];
}
