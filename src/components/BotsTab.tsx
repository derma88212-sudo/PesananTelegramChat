    ...
    <div className="p-6 space-y-6">
      ...
      <div className="space-y-3">
        {bots.length === 0 ? (
          ...
          bots.map((b) => {
            const isOnline = b.status === 'online' || b.is_running;
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="font-bold text-slate-900 text-sm">{b.bot_name}</span>
                      <span
                ...
                <div className="flex items-center gap-2 self-end sm:self-center">
                  {isOnline ? (
                    <button
                      disabled={actionId === b.token_id}
                      onClick={() => handleStop(b.token_id)}
                    ...
                    <button
                      disabled={actionId === b.token_id}
                      onClick={() => handleLaunch(b.token_id)}
                  ...
                  <button
                    onClick={async () => {
                      const confirmed = await dialogConfirm({
                        ...
                        message: `Apakah Anda yakin ingin menghapus token bot "${b.bot_name}"?`,
                        confirmLabel: 'Ya, Hapus',
                        cancelLabel: 'Batal',
                        isDestructive: true
                      });
                      if (confirmed) onDeleteBot(b.token_id);
                    }}
