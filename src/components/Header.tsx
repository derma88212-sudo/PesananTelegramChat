        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-linear-to-tr from-blue-700 via-indigo-600 to-blue-500 text-white rounded-2xl flex items-center justify-center shadow-md shadow-blue-600/25 shrink-0">
              ...
              <div className="leading-tight">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-2 py-0.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border border-emerald-200/80 rounded-full text-[10px] font-bold transition-all"
          ...
          <div className="flex items-center gap-1.5 sm:gap-3">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-slate-50 hover:bg-slate-100 text-slate-800 border border-slate-200 rounded-xl px-2.5 sm:px-3 py-2 text-xs font-semibold pr-7 cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-2xs transition-all"
              ...
              <Globe className="w-3.5 h-3.5 text-slate-400 absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none" />
            </div>
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-2.5 sm:px-3 py-2 border rounded-xl text-xs font-semibold transition-all hover:shadow-xs active:scale-95 ${
                permission === 'granted'
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 rounded-xl text-xs font-bold transition-all hover:shadow-xs active:scale-95"
            ...
            <div className="flex items-center gap-2 pl-1">
              <div className="w-8 h-8 rounded-full bg-linear-to-tr from-slate-100 to-slate-200 border border-slate-300 text-slate-700 flex items-center justify-center text-xs font-bold shadow-2xs">
            ...
            <button
              onClick={onLogout}
              className="p-2 text-slate-400 hover:text-rose-600 hover:bg-rose-50 rounded-xl transition-all ml-0.5 sm:ml-1 active:scale-95"
