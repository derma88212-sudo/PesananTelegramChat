...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems: SidebarNavItem[] = [
    ...
    { id: 'referral', label: 'Tautan Promosi', icon: Link2 },
    { id: 'broadcast_history', label: 'Riwayat Broadcast', icon: History },
    { id: 'database', label: t('tab_database', currentLang), icon: Database, isHighlight: true },
    { id: 'env_vars', label: 'Environment Variables', icon: Key },
    { id: 'settings', label: t('tab_settings', currentLang), icon: SettingsIcon },
    { id: 'admins', label: t('tab_admins', currentLang), icon: Shield },
    { id: 'super_admin', label: 'Super Admin (Root)', icon: UserCheck }
  ];
